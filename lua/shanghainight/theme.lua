...
function M.setup(opts)
  ...
  local colors = require("shanghainight.colors").setup(opts)
  local groups = require("shanghainight.groups").setup(colors, opts)
  ...
  vim.g.colors_name = "shanghainight-" .. opts.style
