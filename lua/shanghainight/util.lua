...
function M.invert(color)
  ...
  elseif type(color) == "string" then
    local hsluv = require("shanghainight.hsluv")
    if color ~= "NONE" then
...
---@param groups shanghainight.Highlights
...
function M.cache.file(key)
  return vim.fn.stdpath("cache") .. "/shanghainight-" .. key .. ".json"
end

---@param key string
function M.cache.read(key)
  ---@type boolean, shanghainight.Cache
...
---@param key string
---@param data shanghainight.Cache
