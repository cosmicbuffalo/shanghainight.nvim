...
function M.setup()
  local shanghainight = require("shanghainight")
  ...
  -- shanghainight.setup({ plugins = { all = true } })
  for _, extra in ipairs(names) do
    local info = M.extras[extra]
    local plugin = require("shanghainight.extra." .. extra)
    for style, style_name in pairs(styles) do
      local colors, groups, opts = shanghainight.load({ style = style, plugins = { all = true } })
      local fname = extra
        ...
        .. "."
        .. info.ext
      colors["_upstream_url"] = "https://github.com/folke/shanghainight.nvim/raw/main/extras/" .. fname
      colors["_style_name"] = "Shanghai Night" .. style_name
      colors["_name"] = "shanghainight_" .. style
      colors["_style"] = style
      print("[write] " .. fname)
